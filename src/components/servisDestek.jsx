        ...
        <div className=''>
            <div className=' h-[750px] bg-cover bg-center bg-[url("https://images.pexels.com/photos/7682340/pexels-photo-7682340.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]'>
                <div className='p-6 pt-72  flex-wrap flex-col flex justify-end items-end '>
                    ...
                    <div className='w-3/6 ms-4 px-4 py-2 md:text-xl text-white  bg-dark_mode rounded-b-md bg-opacity-75 text-sm'> Merkez Servis Türkiyenin en geniş servis ağına sahipdir. Lg  Beyaz Eşyalarınız İçin İhtiyacınız olan servis hizmetini Merkez Servisten alın, size en yakın servisi 30 dk içinde yönlendirelim. </div>
